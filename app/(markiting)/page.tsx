...
export default function LandingPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    void signIn("password", data)
      .then(() => {
        // Do not redirect to verification step after sign-in
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-lg text-gray-600 sm:text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
              Get bite-sized knowledge delivered to your inbox every morning. Choose your interests, and our AI curates
              fascinating insights just for you.
            </p>
            {!isAuthenticated && (<div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
      ...
      <Socia />
      {/* CTA Section */}
      {!isAuthenticated && (<section className="py-20 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500">
        <div className="container mx-auto px-4">
